<!-- content-wrapper ends -->
  ...
  All rights reserved.</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Powered by <a href="https://vmaxindia.com/" target="blank"> <img src="{{ url('assets/images/vmax2.png')}}" width="80"></a> </span>
          </div>
        </footer>
        <!-- partial -->
      </div>
...
$(document).ready(function(){
 ...
 <script src='https://cdn.jsdelivr.net/jquery.validation/1.15.1/jquery.validate.min.js'></script>
  ...
  <script src="{{ url('assets/js/todolist.js')}}"></script>
    <script src="{{ url('assets/js/bootstrapbundle.min.js')}}"></script>
  <!-- endinject -->
