...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets/vendors/font-awesome/fontawesome-6.1.1/css/all.css')}}">
 <link rel="stylesheet" href="{{ url('assets/vendors/bootstrap5_icons/bootstrap-icons.css')}}">
  <!-- endinject -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
         ...
         @endphp
        <a class="navbar-brand brand-logo" href="{{ Session::get('dashboard'); }}"><img src="{{ url('assets/images/main_logo2.png')}}" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{ Session::get('dashboard'); }}"><img src="{{ url('assets/images/mepma.png')}}" alt="logo"/></a>
      </div>
