          ...
          <div class="row">
              <div class="col-md-12">
                  <!--<form action="" method="post">
                      @csrf
                  <p>Date: <input type="date" id="datepicker" name="datesel" value="{{$datesel}}"></p>
                  <input type="submit" name="search" value="search">
                  </form>-->
                  
                  Date : {{ date('d-m-Y',strtotime($fromdate)) }}  ULB: <strong>{{$ulbname[0]->ulbname}}</strong>
              </div>
          </div>
                  ...
                  <div class="col-md-12">
                    <div class="table-responsive" style="overflow-x: unset !important; ">  
                      <table id="example1" class="display expandable-table" style="width:100%">
                          ...
                          $totalOtherEstablishments+=$houseHoles[$val->ward_id]['otherestablishments'];
                          ...
                          <tr>
                              ...
                              <td>{{$houseHoles[$val->ward_id]['otherestablishments']}}</td>
