                ...
                <div class="table-content">
                       ...
                       <div class="card-header p-0"> <div class=" bg-head"><b>Personal Information</b></div> </div>
                        <div class="card-body">
                          ...
                          <!--</div>-->
                            ...
                            <!--  <input type="" name="emp_id" value="{{ $employeesDTL[0]->emp_id }}" class="form-control">-->
                            ...
                            <!--  <label> Employee Type <span class="mandatory">*</span></label>-->
                              <!--<input type="" name="emp_id" value="{{ $employeesDTL[0]->emp_id }}" class="form-control">-->
                            <!--  <select class="form-control-sm  select-input" name="employee_type" disabled>-->
                            <!--    <option value="">Select</option>-->
                            <!--    @if($employeetypes)-->
                            <!--    @foreach($employeetypes as $key=> $val)-->
                            <!--     <option value="{{ $val->employee_type_id }}" @if($val->employee_type_id == $employeesDTL[0]->employee_type) selected @endif>{{ $val->employee_type_desc }}</option>-->
                  ...
                  <div class="user-profile-bg"> 
                    ...
                    <div class="col-md-9 order-sm-first order-last">
                          ...
                          <br>
                         <div class="mb-4 bg-head"><b>Native details </b></div>
                          <div class="row">
                            <!--<div class="col-md-4">-->
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="text" class="form-control form-control-sm mb-3" placeholder="" id="district-field" name="native_district" value="{{ $employeesDTL[0]->native_district }}">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="file" class="form-control form-control-sm mb-3" placeholder="" name="district_certi">
                            </div>
                        </div>
                        <div class="mb-4 bg-head"><b>Statutory details </b></div>
                           <div class="row">
                            ...
                            <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control form-control-sm mb-3" placeholder="" value="{{ $employeesDTL[0]->current_basic_salary }}" name="current_basic_salary" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="current_basic_salary">
                                </div>
                                ...
                                <div class="col-md-4">
                                  ...
                                  <input type="text" id="esi_number" class="form-control form-control-sm mb-3" placeholder="" @if($employeesDTL[0]->current_basic_salary >21000) readonly @endif value="{{ $employeesDTL[0]->esi_number }}" name="esi_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeydown="if(event.key==='.'){event.preventDefault();}">
                                </div>
                          </div>
                          <div class="mb-4 bg-head"><b>Education Details</b></div>
                          <div class="row">
                          <div class="col-md-4">
                           ...
                           <div class="col-md-4 height_cet" style='display:@if($employeesDTL[0]->degree>1)block@else none @endif'>
                              ...
                              <input type="file" class="form-control form-control-sm mb-3" placeholder="" name="highest_dgre_certificates">
                            </div>
                          </div>
                         <div class="mb-4 bg-head"><b>Professional Information</b></div>
                          <div class="row">
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4 mt-3">
                                  ...
                                  <input type="date" class="form-control form-control-sm" placeholder="" value="{{ $employeesDTL[0]->retirement_date }}" id="retirement_date" name="retirement_date" readonly="">
                      ...
                      <div class="row">
                        ...
                        <div class="mt-3 mb-3 bg-head"><b>Disciplinary cases/suspensions <span class="mandatory">*</span></b></div>
                          <textarea class="w-100 textarea-h" name="discplinary_cases_suspensions">{{ $employeesDTL[0]->discplinary_cases_suspensions }}</textarea>
                           <div class="mt-3 mb-3 bg-head"><b>Remarks <span class="mandatory"></span></b></div>
                              <textarea class="w-100 textarea-h" name="emp_Remarks">{{ $employeesDTL[0]->emp_Remarks }}</textarea>
                              <span class="text-danger">{{$errors->first('emp_Remarks')}}</span>
                          <div class="mt-3 mb-3 bg-head"><b>Objective/inspirations <span class="mandatory"></span></b></div>
                            <textarea class="w-100 textarea-h" name="objective_aspirations">{{ $employeesDTL[0]->objective_aspirations }}</textarea>
                          <div class="mt-3 mb-3 bg-head"><b>Contributions/inspirations <span class="mandatory"></span></b></div>
                          ...
                          @if($employeesDTL[0]->remarks != null)
                              <div class="mt-3 mb-3 bg-head"><b>Remarks by AO <span class="mandatory"></span></b></div>
                              <textarea class="w-100 textarea-h" >{{ $employeesDTL[0]->remarks }}</textarea>
                          @endif
                      
                    
                    <div class="text-center mt-2 mb-2 ">
                         <button class="btn btn-md btn-submit" name="submit" value="submit" style="width: 12%;">
                             ...
                             @if(session()->get('user_type') == 'AO')
                             @if($employeesDTL[0]->approve_status == 0)
                                <button class="btn btn-danger btn-sm mt-3 ml-5" id="reject_btn" type="button" style="width: 12%;">Reject</button>
                                <lable for="remarks" class="ml-5 mt-2">Remarks</lable>
                                <textarea name="remarks" class="mt-5" row="5" id="remarks"></textarea>
                             @endif
                             @endif
                       </div>
                    </div>
