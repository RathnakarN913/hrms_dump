        ...
        <div class="content-wrapper">
              ...
              <div class="bg-white">
                        <div class="table-content">
                          <div class="mb-4"><b>Attendance report for the month of {{ $month_dates_range[0]->salary_dates_range }} - {{ date('Y') }} </b></div>
                          
                         <table width="100%" border="1" cellspacing="0" cellpadding="0" class=" mt20 table table-bordered text-center">
                              <tbody>
                                ...
                                @php
                                $status ="Not updated";
                                if(in_array($val->distid,$districtids))
                                {
                                   $status ="Updated";
                                   @endphp
                                   <input type="hidden" name="updateddistricts" value="{{$val->distid}}">
                                   @php
                                }
                                @endphp  
                        ...
                        <center><a href="{{url('create_payslips')}}"><button class="export-xl btn btn-success btn-sm" style="background-color: #56a400; border-color: #56a400;">Generate pay slips</button></a></center>
                      </div>
            </form>
