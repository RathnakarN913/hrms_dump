  ...
  $('[data-toggle="tooltip"]').tooltip()
      ...
      <div class="main-panel">
        <div class="content-wrapper">
               ...
               <!--     </div>-->
               <!-- @endif-->
               <div class="mb-4"><h4><b>Add Employees Details</b></h4></div>
              <div class="bg-white">
                    ...
                    <div id="private_form" style="display:@if(count($errors) > 0) block @else none @endif">
                      ...
                      <div class="user-profile-bg"> 
                        <form name="add" method="post" action="{{ route('CreateAddEmployee') }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="employee_type" id="employee_type_val" value="{{old('employee_type')}}" class="emp_val">
                        ...
                        <div class="col-md-9 order-sm-first order-last">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <input type="date" class="form-control form-control-sm" value="{{old('dob')}}" placeholder="" onchange="submitBday(this.value)" name="dob" min="1950-01-01" max="<?php echo date("Y-m-d") ?>" >
                                ...
                                <div class="col-md-12 mb-3">
                                  ...
                                  <select class="form-control-sm  select-input" name="co">
                                    ...
                                    @if($relations)
                                        @foreach($relations as $key=> $val)
                                         <option value="{{ $val->id }}" @if($val->id == old('co')) selected @endif>{{ $val->relation }}</option>
                                        @endforeach
                                    @endif
                                  </select>
                                  ...
                                  <label>Father/husband name<span class="mandatory">*</span></label>
                                ...
                                <!--  <input type="text" class="form-control form-control-sm " id="" value="{{old('emp_id')}}" placeholder="Employee ID" name="emp_id">-->
                             ...
                             <div class="mb-4 bg-head"><b>Professional</b></div>
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                  ...
                                  <input type="date" class="form-control form-control-sm" placeholder="" value="{{old('retirement_date')}}" id="retirement_date" name="retirement_date" readonly>
                                   <!--<small style="font-size:12px;"><i> <b>Note:</b> Upload files PDF, JPG, PNG only</i></small>-->
                                 ...
                                 <div class="col-md-4">
                                  <label>Category </label>
                                   <select class="form-control-sm   select-input" name="category">
                                        <option value="">Select</option>
                                        <option value="c1" @if('c1' == old('category')) selected @endif>C1</option>
                                        <option value="c2" @if('c2' == old('category')) selected @endif>C2</option>
                                        <option value="c3" @if('c3' == old('category')) selected @endif>C3</option>
                                  </select>
                            ...
                            <div class="current_designation">
                                       ...
                                       <div class="row">
                                        <div class="col-md-8 ">
                                          ...
                                          <div class="col-md-6  ">
                                            ...
                                            <input type="date" name="start_date[]" class="form-control form-control-sm" value="{{old('start_date.0')}}" placeholder="Start date" onkeydown="return false">
                                            <span class="text-danger">{{$errors->first('start_date.0')}}</span>
                                          </div>
                                          <div class="col-md-6 ">
                                              <label>End date <span class="mandatory"></span></label>
                                            <input type="date" name="end_date[]" value="{{old('end_date.0')}}" class="form-control form-control-sm" placeholder="End date" onkeydown="return false">
                                         ...
                                         <div class="col-md-4">
                                              <label>Location <span class="mandatory"></span></label>
                                              <input type="text" class="form-control form-control-sm" id="work_experience_location" placeholder="" value="{{old('work_experience_location.0')}}" name="work_experience_location[]">
                              ...
                              <div class="row mt-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                      ...
                                      <input type="text" class="form-control form-control-sm  " placeholder="" id="current_basic_salary" value="{{old('current_basic_salary')}}" name="current_basic_salary" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" >
                                      <span class="text-danger">{{$errors->first('current_basic_salary')}}</span>
                                    </div>
                                    
                                    <div class="col-md-4">
                                      <label>PF Number <span class="mandatory">*</span></label>
                                      <input type="text" class="form-control form-control-sm  " placeholder="" value="{{old('pf_number')}}" id="pf_number" name="pf_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeydown="if(event.key==='.'){event.preventDefault();}">
                        ...
                        <div class="mb-3 bg-head"><b>Bank Details</b></div>
                          ...
                          <div class="row">
                             ...
                             <input type="text" class="form-control form-control-sm " placeholder="" value="{{old('nominee_details')}}" name="nominee_details">
                             <span class="text-danger">{{$errors->first('nominee_details')}}</span>
                                ...
                                <div class="col-md-4">
                                  ...
                                  <select class="form-control-sm   select-input" name="nominee_relation">
                                    ...
                                    @if($relations)
                                    @foreach($relations as $key=> $val)
                                     <option value="{{ $val->id }}" @if($val->id == old('nominee_relation')) selected @endif>{{ $val->relation }}</option>
                                    @endforeach
                                    @endif
                                  </select>
                                ...
                                <div class="col-md-4">
                                 ...
                                 <select class="form-control-sm  select-input " name="nominee_gender">
                                    <option value="">Select</option>
                                    <option value="Male" @if('Male' == old('nominee_gender')) selected @endif>Male</option>
                                    <option value="female" @if('female' == old('nominee_gender')) selected @endif>female</option>
                                    <option value="Transgender" @if('Transgender' == old('nominee_gender')) selected @endif>Transgender</option>
                                  </select>
                                  <span class="text-danger">{{$errors->first('nominee_gender')}}</span>
                                </div>
                                <div class="col-md-4 mb-3">
                                  <label>Nominee DOB <span class="mandatory"></span></label>
                                  <input type="date" class="form-control form-control-sm " placeholder="" value="{{old('nominee_dob')}}" name="nominee_dob" onkeydown="return false">
...
<script>
    $(document).ready(function(){
        $('#current_basic_salary').on('change',function(){
            ...
            if(sal > 15000){
                $('#pf_number').prop('readonly',true);
            }else{
                $('#pf_number').prop('readonly',false);
            }
        })
    })
</script>
...
// }, "Age should not be less than 18 years!");
    ...
    function validateDesignationAvaibility(e) {
        ...
        var employee_type = $('#employee_type_val').val();
