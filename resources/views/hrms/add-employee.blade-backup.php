                  ...
                  <div class="user-profile-bg">
                    ...
                    <div class="col-md-9 order-sm-first order-last">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="text" class="form-control form-control-sm " placeholder="Surname" id="surname-field" name="surname">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 pt-3">
                              ...
                              <textarea class="textarea-form" name="communication_address" id="communication_address" style="height: 64px;" name="communication_address"></textarea>
                            </div>
                          ...
                          <div class="mb-3 mt-3 ml-3">
                            ...
                            <div class="col-md-8">
                              ...
                              <textarea class="textarea-form" name="permenant_address" id="permenant_address" style="height: 64px;"></textarea>
                            </div>
                            <div class="col-md-4">
                              <label>Pin code <span class="mandatory">*</span></label>
                              <input type="text" class="form-control form-control-sm mb-3" maxlength="6" placeholder="" id="permenant_address_pin_code" name="permenant_address_pin_code" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeydown="if(event.key==='.'){event.preventDefault();}">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                              ...
                              <input type="text" class="form-control form-control-sm  " id="state-field" placeholder="" name="state">
                            </div>
                            <div class="col-md-4">
                              <label>Mobile number <span class="mandatory">*</span></label>
                             <input type="text" class="form-control form-control-sm " maxlength="10" placeholder="" name="mobile_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeydown="if(event.key==='.'){event.preventDefault();}">
                            </div>
                            <div class="col-md-4">
                              <label>Alternative mobile number <span class="mandatory"></span></label>
                              <input type="text" class="form-control form-control-sm  " maxlength="10" placeholder="" name="alternative_mobile_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeydown="if(event.key==='.'){event.preventDefault();}">
                            </div>
                            <div class="col-md-4 mb-3">
                              <label>Email id <span class="mandatory">*</span></label>
                              <input type="email" class="form-control form-control-sm  " placeholder="" name="email_id">
                            </div>
                            <div class="col-md-4">
                           ...
                           {{-- <!--<div class="col-md-4">-->
                            ...
                            <div class="col-md-4 mb-3">
                              ...
                              <select class="form-control-sm  select-input" name="marital_status" id="marital_status" onChange="GetMaritalStatusDtl();">
                                <option value="">Select</option>
                                @if($matrialstatus)
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="text" class="form-control form-control-sm  " placeholder="" name="if_select_single" id="if_select_single">
                            </div>
                            <div class="col-md-4">
                              <label>Nationality <span class="mandatory">*</span></label>
                              <input type="text" class="form-control form-control-sm" id="nationality" placeholder="" name="nationality">
                            </div>
                             <div class="col-md-4 mb-3">
                          ...
                          <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="text" class="form-control form-control-sm" id="university_college" placeholder="" name="university_college">
                            </div>
                            <div class="col-md-4 mb-3">
                              <label>Certificates Upload <span class="mandatory">*</span></label>
                              <input type="file" class="form-control form-control-sm  " placeholder="" name="certificates">
                               <small style="font-size:12px;"><i> <b>Note:</b> Upload files PDF, JPG, PNG only</i></small>
                            </div>
                            <div class="col-md-4">
                         ...
                         <div class="mb-4 bg-head"><b>Professional</b></div>
                          ...
                          <div class="col-md-4 mb-3">
                              <label>Date of joining <span class="mandatory">*</span> <span style="font-size: 12px;">( Net effective date)</span></label>
                                <input type="date" class="form-control form-control-sm" placeholder="" name="date_of_joining" onkeydown="return false">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 pr-0">
                              ...
                              <input type="text" class="form-control form-control-sm" id="location" placeholder="" name="location">
                            </div>
                            <div class="col-md-4 mb-3">
                              <label>DOJ <span style="font-size: 12px;">(Certificates to be uploaded)</span> <span class="mandatory">*</span></label>
                              <input type="file" class="form-control form-control-sm  " placeholder="" name="doj">
                               <small style="font-size:12px;"><i> <b>Note:</b> Upload files PDF, JPG, PNG only</i></small>
                            </div>
                          </div>
                              ...
                              <div class="col-md-11 pt-2" style="border-right: 1px #aedde1  solid;">
                                <div class="row">
                                     <div class="col-md-4 mb-3">
                                      ...
                                      <select class="form-control-sm select-input" id="current_designations" onchange="validateDesignationAvaibility(this.value)" name="current_designation[]">
                                        <option value="">Select</option>
                                        @if($designations)
                                            @foreach($designations as $key=> $val)
                                             <option value="{{ $val->id }}">{{ $val->description }}</option>
                          ...
                          <p class="mt-3 mb-3"><b>Work Experience</b></p>
                            ...
                            <div class="row b-3 ml-1" style="background-color: #e2eeef;">
                                ...
                                <div class="col-md-1 p-0 d-flex align-items-center justify-content-center" >
                                     ...
                                     <!--<span class="btn-minus" style="margin-top: 20px; display: inherit;"><i class="bi bi-dash"></i></span>-->
                                </div>
                    ...
                    <div class="mb-3 bg-head"><b>Bank Details</b></div>
                      ...
                      <div class="row">
                         ...
                         <input type="text" class="form-control form-control-sm " placeholder="" name="relation_name">
                        </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 mb-3">
                              ...
                              <input type="date" class="form-control form-control-sm  " placeholder="" name="relation_dob" onkeydown="return false">
                            </div>
                            <div class="col-md-4">
                              <label>Relation occupation <span class="mandatory">*</span></label>
                              <input type="text" class="form-control form-control-sm  " placeholder="" name="relation_occupation">
                            </div>
                            <div class="col-md-4 mb-3">
